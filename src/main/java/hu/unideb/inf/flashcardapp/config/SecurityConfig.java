package hu.unideb.inf.flashcardapp.config;

import hu.unideb.inf.flashcardapp.service.UserService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http)
        ...
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(req -> req.requestMatchers("/", "/login.html", "/register.html", "/css/**", "/javascript/**").permitAll()
